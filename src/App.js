...
import ProtectedRoute, { ManagementRoute, RoleRoute } from "./components/auth/ProtectedRoute";
    ...
    <AuthProvider>
      <Router>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route element={<RoleRoute allowedLevels={["Desenvolvedor", "Administrador", "CEO"]} />}>
